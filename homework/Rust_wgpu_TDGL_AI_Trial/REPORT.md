...
| 现象 | 文献预测 | 本实验结果 | 一致性 |
|:----:|:--------:|:----------:|:------:|
| 整数匹配场处临界电流峰值 | 每个 matching field 处出现峰 | B/B_φ=1,2 处钉扎增强 | ✓ 定性一致 |
| Individual pinning: 第一匹配场后下降 | 第一匹配场后急剧下降 | B/B_φ>1 时增强比下降 | ✓ 定性一致 |
| Multiple pinning: 各匹配场峰值相等 | 峰值大致相等 | B/B_φ=1,2 增强比相近 | ✓ 定性一致 |
