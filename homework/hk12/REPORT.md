...
| 外场 H | M_sim | M_theory = tanh(H/T) | 绝对误差 |
|:------:|:-----:|:--------------------:|:--------:|
...
| 临界慢化 | T ≈ T_c 时收敛慢 | Wolff/Swendsen-Wang 算法 |
| T_c 估计误差 | 影响 log-log 拟合 | Binder 比方法 |
